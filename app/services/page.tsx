  ...
  const process = [
    {
      step: "01",
      title: "Brief",
      desc: "Tell us what you need. We'll ask the right questions to understand your goals, constraints, and timeline.",
    },
    {
      step: "02",
      title: "Proposal",
      desc: "We send a detailed scope, timeline, and quote. No vague estimates — just clear deliverables.",
    },
    {
      step: "03",
      title: "Build",
      desc: "We design, develop, and test your system. You get progress updates throughout.",
    },
    {
      step: "04",
      title: "Deliver",
      desc: "We hand over all files, firmware, and documentation. Support included after delivery.",
    },
  ];
      ...
      <section className="relative bg-white border-b border-slate-100 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-20 md:py-28">
          ...
          <p className="mt-6 text-base text-slate-500 leading-relaxed max-w-lg">
            From a single PCB to a complete business automation system — HezTec
            covers the full spectrum of hardware engineering services.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="space-y-6">
            {mainServices.map((s) => (
              ...
              >
                {/* Service header */}
                <div className="flex min-[100px]:max-[770px]:flex-col items-start gap-5 p-7 bg-white">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <Link
                      ...
                      >
                        Shop Components <ChevronRight size={13} />
                      </Link>
                    :
                    <Link
                        href="/contact"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {businessService.examples.map((ex, i) => (
              ...
              >
                ...
                <p className="text-slate-500 text-sm leading-relaxed pl-5">
                  {ex.desc}
                </p>
              </div>
            ))}
          ...
          <div className="mt-10 p-5 rounded-xl border border-green-100 bg-green-50 flex items-start gap-3">
            ...
            <p className="text-sm text-green-800 leading-relaxed">
              <strong>Don't see your use case?</strong> Every business has
              unique needs. If you have a problem that hardware can solve, we'd
              like to hear about it. We'll assess the feasibility and propose a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {process.map((p, i) => (
              <div key={i} className="relative">
                ...
                {i < process.length - 1 && (
                  <div
                    className="hidden lg:block absolute top-6 left-full w-full h-[1px] bg-slate-100 z-0"
                    style={{
                      width: "calc(100% - 24px)",
                      left: "calc(50% + 12px)",
                    }}
          ...
          >
            <div className="max-w-xl">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Describe your project and we'll get back to you with a clear
