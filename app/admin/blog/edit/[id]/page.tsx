...
export default function AdminBlogPage() {
  ...
  const fetchPosts = async () => {
    ...
    let query = supabase
      .from("blog_posts")
      .select(
        "id, title, slug, category, status, author_name, published_at, created_at",
      )
    ...
    >
      ...
      <div className="bg-white border-b border-slate-100 px-6 lg:px-10 py-6 flex items-center justify-between gap-4">
        <div>
          ...
          <h1
            className="serif text-2xl text-slate-900"
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-100">
                  <th className="text-left px-6 py-4 text-[10px] font-black uppercase tracking-widest text-slate-300">
                    Title
                  </th>
                  <th className="text-left px-4 py-4 text-[10px] font-black uppercase tracking-widest text-slate-300 hidden md:table-cell">
                    Category
                  </th>
                  <th className="text-left px-4 py-4 text-[10px] font-black uppercase tracking-widest text-slate-300 hidden lg:table-cell">
                    Author
                  </th>
                  <th className="text-left px-4 py-4 text-[10px] font-black uppercase tracking-widest text-slate-300 hidden lg:table-cell">
                    Date
                  </th>
                  <th className="text-left px-4 py-4 text-[10px] font-black uppercase tracking-widest text-slate-300">
                    Status
                  </th>
